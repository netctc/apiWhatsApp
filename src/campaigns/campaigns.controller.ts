...
export class CampaignsController {
  ...
  launch(@CurrentPrincipal() principal: ApiPrincipal, @Param("id") id: string) {
  ...
  pause(@CurrentPrincipal() principal: ApiPrincipal, @Param("id") id: string) {
  ...
  resume(@CurrentPrincipal() principal: ApiPrincipal, @Param("id") id: string) {
  ...
  cancel(@CurrentPrincipal() principal: ApiPrincipal, @Param("id") id: string) {
